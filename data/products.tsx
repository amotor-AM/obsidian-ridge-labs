...
export const products: Product[] = [
  ...
  },
  {
    ...
    fullDescription: 'Cove gives thoughts a private place to become useful. Write, dictate, add photos or voice memos, notice themes, revisit memories, and ask questions grounded in your own journal. Apple Foundation Models handles per-entry insight, follow-up questions, and the weekly reflection on-device, while NaturalLanguage provides multilingual semantic search and a local fallback when Apple Intelligence is unavailable. Writing is never paywalled. Face ID lock, Markdown, JSON, and full ZIP export, a Day One importer, and complete in-app erase keep the archive yours, and optional Health State of Mind sync is permission-based. Journal data lives in a local store with optional private iCloud sync through your own account, and Cove remains in active development.',
    icon: BookOpen,
    specs: [
      { label: 'Product stage', value: 'In Development' },
  ...
  },
  {
    ...
    workflow: [
      ...
      { title: 'Generate Draft Cards', description: 'Apple Foundation Models creates source-grounded drafts; a local text-analysis fallback keeps generation useful without Apple Intelligence.' },
